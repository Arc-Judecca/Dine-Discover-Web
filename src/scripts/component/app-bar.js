class AppBar extends HTMLElement {
  ...
  render() {
    ...
    <nav id="nav" class="menu">
      <h1>
        <a href="./" title="Navbar Brand">Dine Discover</a>
      </h1>
      ...
      <ul class="menu-list">
          ...
          <li><a href="https://www.linkedin.com/in/gfibarkah13jud09/" title="Link ke about us" target="_blank" rel="noreferrer">About
                  Us</a></li>
      </ul>
    </nav>
    `;
